package com.canbot.retrofitdemo.view.custom;
    ...
    public void onStartPreview() {
        camera.setPreviewCallbackWithBuffer(new Camera.PreviewCallback() {
            ...
            public void onPreviewFrame(byte[] data, Camera camera) {
                if (listener != null) {
                    listener.onPictureTaken(new CameraPreviewData(data.clone(), previewSize.width, previewSize.height, previewDegreen, front));
                }
